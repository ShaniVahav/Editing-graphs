...
void clean(){
    ...
    void center(){
        ...
        GraphAlgorithm a = new GraphAlgorithm();
        Graph mygraph = new Graph();
        a.load("C:\\Users\\barse\\IdeaProjects\\Ex2\\src\\G2.json");
     //   System.out.println(a.getGraph().edgeSize());
        NodeData A = a.center();
    ...
    void tsp() {
       GraphAlgorithm a = new GraphAlgorithm();
        a.load("C:\\Users\\barse\\IdeaProjects\\Ex2\\src\\G3.json");
    ...
    void save() {
        GraphAlgorithm a = new GraphAlgorithm();
        Graph mygraph = new Graph();
        a.load("C:\\Users\\barse\\IdeaProjects\\Ex2\\src\\G1.json");
         Boolean v =a.save("C:\\Users\\barse\\IdeaProjects\\Ex2\\src\\G4.json");
         assertTrue(v==true);
